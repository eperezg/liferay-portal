...
public class ContentSpaceCollectionResource
	...
	private void _checkViewPermission(PermissionChecker permissionChecker)
		throws PortalException {

		boolean contains = GroupPermissionUtil.contains(
	...
	private PageItems<Group> _getPageItems(
		...
		_checkViewPermission(permissionChecker);
